...
describe('Service Tests', () => {
    ...
    describe('Enrollment_Commission Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(Enrollment_CommissionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/enrollment-commissions/' + 123);
            });
            it('should return Enrollment_Commission', () => {

                let entity: Enrollment_Commission;
                service.find(123).subscribe((_entity: Enrollment_Commission) => {
                    entity = _entity;
                });
